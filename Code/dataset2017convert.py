...
path = 'G:\\TUI\\MasterThesisMain\\Datasets\\CICIDS2017\\GeneratedLabelledFlows\\Monday-WorkingHours.pcap_ISCX\\'

listOfFiles = os.listdir(path)

dstpath = 'G:\\ds2017benign\\'

for fname in listOfFiles:
    print(fname + ' dataframe')

    dstpath2 = dstpath + 'normal\\'
    os.mkdir(dstpath2)
    ...
    df.drop(labels=[
        ...
        ' Destination Port', ' Protocol', ' Timestamp', ' Bwd PSH Flags',
        ' Fwd URG Flags', ' Bwd URG Flags', ' PSH Flag Count',
        ' ECE Flag Count', 'Fwd Avg Bytes/Bulk', ' Fwd Avg Packets/Bulk',
        ' Fwd Avg Bulk Rate', ' Bwd Avg Bytes/Bulk', ' Bwd Avg Packets/Bulk',
        'Bwd Avg Bulk Rate', ' RST Flag Count', ' Fwd Header Length.1',
